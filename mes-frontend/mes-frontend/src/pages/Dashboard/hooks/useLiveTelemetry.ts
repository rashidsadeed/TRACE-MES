...
import { getTelemetryBase } from "../../../services/dashboardService";
 ...
 *
 * Uses dashboardService.getTelemetryBase() to fetch base values
...
export const useLiveTelemetry = (machineId: string | null) => {
  ...
  useEffect(() => {
    ...
    const startTelemetry = async () => {
      const base = await getTelemetryBase(machineId);
