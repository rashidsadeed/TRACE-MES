...
import type { AssignmentType, ProductionLine, Machine } from "../types";
...
const AssignmentFields: React.FC<AssignmentFieldsProps> = ({
  ...
  <>
    ...
    <Form.Item
      ...
      rules={[{ required: true, message: "Select how to assign this job" }]}
    >
      <Radio.Group>
    ...
    {assignmentType === "custom-line" && (
      <>
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "Select machines for this line" }]}
        >
          <Select
            mode="multiple"
