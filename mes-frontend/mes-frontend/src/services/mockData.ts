...
export const MOCK_WORK_ORDERS: MockWorkOrder[] = [
  { key: "1", id: "WO-2024-001", product: "Industrial Pump X500", quantity: 500, completed: 320, priority: "High", status: "In Progress", dueDate: dayjs().add(1, "day").format("YYYY-MM-DD"), assignmentType: "existing-line", assignedLine: "LINE-01" },
